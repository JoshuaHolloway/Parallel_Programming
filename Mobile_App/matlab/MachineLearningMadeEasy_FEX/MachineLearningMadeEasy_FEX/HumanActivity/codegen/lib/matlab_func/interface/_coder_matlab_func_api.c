...
#include "_coder_matlab_func_mex.h"
 ...
 * Return Type  : void
 */
void matlab_func_api(const mxArray * const prhs[2], int32_T nlhs, const mxArray *
                     plhs[1])
{
  real_T (*z)[4];
  real_T (*x)[4];
 ...
 * Return Type  : void
 */
void matlab_func_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_matlab_func_api.c
 *
 * [EOF]
 */
