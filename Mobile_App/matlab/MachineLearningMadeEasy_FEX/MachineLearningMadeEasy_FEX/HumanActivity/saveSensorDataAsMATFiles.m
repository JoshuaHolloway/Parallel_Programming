...
if exist('rawSensorData_train.mat','file') && exist('rawSensorData_test.mat','file')
   ...
   disp(' ')
    ...
    trainActivity = categorical(importdata('/home/josh/Desktop/Parallel_Vision_Research/Mobile_App/matlab/MachineLearningMadeEasy_FEX/MachineLearningMadeEasy_FEX/HumanActivity/UCI_HAR_Dataset/train/y_train.txt'),1:6,activity_labels);
    ...
    filestoload = strcat('UCI_HAR_Dataset/train/Inertial_Signals/',{'*gyro*','total*'});
    ...
    testActivity = categorical(importdata('UCI_HAR_Dataset/test/y_test.txt'),1:6,activity_labels);
    ...
    %filestoload = strcat('/home/josh/Desktop/Parallel_Vision_Research/Mobile_App/matlab/MachineLearningMadeEasy_FEX/MachineLearningMadeEasy_FEX/HumanActivity/UCI_HAR_Dataset/test/Inertial_Signals/',{'*gyro*','total*'});
	% Choose this if you want to load all files
    filestoload = strcat('UCI_HAR_Dataset/test/Inertial_Signals/'); 
