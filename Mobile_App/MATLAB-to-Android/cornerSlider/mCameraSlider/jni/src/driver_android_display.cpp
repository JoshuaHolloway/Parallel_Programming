...
void initDisplay(int width, int height )
{
     ...
     sgDisplayContext.InitDisplayID = (pEnv)->GetMethodID(cachedMainActivityCls, "initDisplay","(II)I");
...
extern "C" 
void putDisplayData(uint8_t *inCh1, uint8_t *inCh2, uint8_t *inCh3)
{
