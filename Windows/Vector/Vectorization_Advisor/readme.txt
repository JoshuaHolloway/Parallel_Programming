This file (example.cpp) is meant to be used with the "Introduction to Advisor XE 2016" and 
"Intel Advisor XE 2016 on the Command Line + Automation" tutorials for Intel® Advisor XE 2016.
